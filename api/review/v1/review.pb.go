...
const file_api_review_v1_review_proto_rawDesc = "" +
	...
	"\x04data\x18\x01 \x01(\v2\x19.api.review.v1.ReviewInfoR\x04data\"x\n" +
	"\x19ListReviewByUserIDRequest\x12\x1f\n" +
	"\x06userID\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\x06userID\x12\x1b\n" +
	"\x04page\x18\x02 \x01(\x05B\a\xfaB\x04\x1a\x02 \x00R\x04page\x12\x1d\n" +
	"\x04size\x18\x03 \x01(\x05B\t\xfaB\x06\x1a\x04\x10d \x00R\x04size\"H\n" +
	"\x17ListReviewByUserIDReply\x12-\n" +
	"\x04list\x18\x01 \x03(\v2\x19.api.review.v1.ReviewInfoR\x04list\"\xa2\x02\n" +
	"\n" +
	"ReviewInfo\x12\x1a\n" +
	...
	"\bappealID\x18\x01 \x01(\x03R\bappealID2\xac\x06\n" +
	"\x06Review\x12k\n" +
...
var file_api_review_v1_review_proto_goTypes = []any{
	...
	(*ListReviewByUserIDRequest)(nil), // 4: api.review.v1.ListReviewByUserIDRequest
	(*ListReviewByUserIDReply)(nil),   // 5: api.review.v1.ListReviewByUserIDReply
...
var file_api_review_v1_review_proto_depIdxs = []int32{
	...
	4,  // 4: api.review.v1.Review.ListReviewByUserID:input_type -> api.review.v1.ListReviewByUserIDRequest
	...
	5,  // 11: api.review.v1.Review.ListReviewByUserID:output_type -> api.review.v1.ListReviewByUserIDReply
